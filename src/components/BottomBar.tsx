...
import SaveIcon from "../../public/Saved icon.svg";
import ChatIcon from "../../public/Chat icon.svg";
import PracticeIcon from "../../public/Practices icon.svg";
...
export type Tab = "Learn" | "Practice" | "Profile" | "Leaderboards";
  ...
  const bottomBarItems: BottomBarItem[] = [
    {
      ...
      href: "/learn",
      icon:
        <Image src={ChatIcon} alt="My Icon" width={50} height={50} />
      // <svg
      //   width="32"
      //   height="32"
      //   viewBox="0 0 32 32"
    ...
    },
    {
      ...
      icon: (
        ...
        //   />
        // </svg>
        <Image src={PracticeIcon} alt="My Icon" width={50} height={50} />
    ...
    },
    {
      ...
      icon: (
        ...
        //   />
        // </svg>
        <Image src={SaveIcon} alt="My Icon" width={50} height={50} />
